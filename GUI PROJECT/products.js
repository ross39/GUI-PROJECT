...
var price = 0;
var amount = 0;
var previous = sessionStorage.cost;
	...
	for(var i = 0; i < 17; i++)
	{
		if(document.getElementById(i).value > 0)
		{
			...
			if(previous != "null")
			{
				...
				sessionStorage.cost = JSON.stringify(amount + previous);
				...
				document.getElementById("cost").innerHTML = "<strong>Current amount in cart: €" + amount + "</strong>";
			}
		}
	}
